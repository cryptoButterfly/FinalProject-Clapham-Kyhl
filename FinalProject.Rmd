...
inputPanel(
  ...
  if (input$x_1 == "Confirmed") { 
        ggplot(coronaStatus, aes_string(y = input$x_1, x=Date)) +
        geom_col() +
        ggtitle("Confirmed Cases by Date") +
        ylab("Confirmed Cases")
      }
  if (input$x_1 == "Deaths") { 
        ggplot(coronaStatus, aes_string(y = input$x_1, x=Date)) +
        geom_col() +
        ggtitle("Fatal Cases by Date") +
        ylab("Fatal Cases")
      }
  if (input$x_1 == "Recovered") { 
        ggplot(coronaStatus, aes_string(y = input$x_1, x=Date)) +
        geom_col() +
